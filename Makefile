...
# --- CFLAGS -----------------------------------------
CFLAGS_gnu = -std=gnu99 -Wall -pedantic -O3 -ffast-math -fopenmp #-msse4.2
...
# --- FLAGS FOR LIME ---------------------------------
#LIMEDIR = ../projects/CPU_tests/DDalphaAMG_ci_F_polytests/dependencies/qio/build/
LIMEDIR = dependencies/qio/
...
OPT_VERSION_FLAGS = $(CFLAGS) $(LIMEFLAGS) $(H5FLAGS) -DPARAMOUTPUT -DTRACK_RES -DPROFILING -DOPENMP -DSSE #-DCOARSE_ODDEVEN_FULL -DOPENMP -DSSE
#OPT_VERSION_FLAGS += -DGCRODR
# OPT_VERSION_FLAGS += -DSINGLE_ALLREDUCE_ARNOLDI -DPIPELINED_ARNOLDI
OPT_VERSION_FLAGS += -DPOLYPREC -DDOUBLE_POLYPREC
#OPT_VERSION_FLAGS += -DBLOCK_JACOBI #-DBJ_DIR_SOLVS #-DPERS_COMMS

DEVEL_VERSION_FLAGS = $(CFLAGS) $(LIMEFLAGS) -DDEBUG -DPARAMOUTPUT -DTRACK_RES -DFGMRES_RESTEST -DPROFILING -DCOARSE_RES -DSCHWARZ_RES -DTESTVECTOR_ANALYSIS -DOPENMP -DSSE #-DOPENMP -DCOARSE_ODDEVEN_FULL -DSSE
#DEVEL_VERSION_FLAGS += -DGCRODR
# DEVEL_VERSION_FLAGS += -DSINGLE_ALLREDUCE_ARNOLDI -DPIPELINED_ARNOLDI
DEVEL_VERSION_FLAGS += -DPOLYPREC -DDOUBLE_POLYPREC
